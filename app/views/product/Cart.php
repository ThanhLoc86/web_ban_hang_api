                        ...
                        <div class="card-body">
                            <?php if ($item['image']): ?>
                                <div class="product-image-container">
                                    <img src="/web_ban_hang/<?php echo $item['image']; ?>" alt="Product Image" class="product-image">
                                </div>
                            <?php endif; ?>
                            
                            <div class="product-details">
                                <p class="product-price">Giá: <span class="price-value"><?php echo number_format($item['price'], 0, ',', '.'); ?> VND</span></p>
                                ...
                                <div class="action-buttons mt-3">
                                    ...
                                    <a href="/web_ban_hang/Product/deleteItem/<?php echo $id; ?>" class="btn btn-delete"
            ...
            <div class="col-12">
                <div class="cart-summary">
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="/web_ban_hang/Product" class="btn btn-continue">
                            <i class="fas fa-arrow-left"></i> Tiếp tục mua sắm
                        </a>
                        <div class="total-price">
                            <strong>Tổng Tiền:</strong>
                            <span id="totalPrice"><?php echo number_format($totalPrice, 0, ',', '.'); ?></span> VND
                        </div>
                        <a href="/web_ban_hang/Product/checkout" class="btn btn-checkout">
        ...
        <div class="row">
            <div class="col-12">
                <div class="empty-cart">
                    ...
                    <a href="/web_ban_hang/Product" class="btn btn-continue mt-3">
                        <i class="fas fa-arrow-left"></i> Tiếp tục mua sắm
                    </a>
                </div>
            </div>
...
<script>
    ...
    function updateQuantity(event, productId) {
        ...
        fetch("/web_ban_hang/Product/updateQuantity/" + productId, {
            method: "POST",
            headers: {
